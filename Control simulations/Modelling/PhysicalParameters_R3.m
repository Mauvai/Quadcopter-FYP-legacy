...
coeff_speed1 = polyfit(PWM,Motor1_Speed,7)
yFitted1=polyval(coeff_speed1, PWM);
plot(PWM,yFitted1,'LineWidth', LineThickness);

coeff_speed2 = polyfit(PWM,Motor2_Speed,7)
yFitted2=polyval(coeff_speed2, PWM);
plot(PWM,yFitted2,'g','LineWidth', LineThickness);

coeff_speed3 = polyfit(PWM,Motor3_Speed,7)
yFitted3=polyval(coeff_speed3, PWM);
plot(PWM,yFitted3,'r','LineWidth', LineThickness);

coeff_speed4 = polyfit(PWM,Motor4_Speed,7)
yFitted4=polyval(coeff_speed4, PWM);
plot(PWM,yFitted4,'c','LineWidth', LineThickness);
...
coeff_thrust1 = polyfit(PWM,Motor1_Thrust,7)
yFitted1=polyval(coeff_thrust1, PWM);
plot(PWM,yFitted1,'LineWidth', LineThickness);

coeff_thrust2 = polyfit(PWM,Motor2_Thrust,7)
yFitted2=polyval(coeff_thrust2, PWM);
plot(PWM,yFitted2,'g','LineWidth', LineThickness);

coeff_thrust3 = polyfit(PWM,Motor3_Thrust,7)
yFitted3=polyval(coeff_thrust3, PWM);
plot(PWM,yFitted3,'r','LineWidth', LineThickness);

coeff_thrust4 = polyfit(PWM,Motor4_Thrust,7)
yFitted4=polyval(coeff_thrust4, PWM);
plot(PWM,yFitted4,'c','LineWidth', LineThickness);
...
% Thrust-Speed
figure
plot(transpose(Motor_Speeds),transpose(Motor_Thrusts),'o','LineWidth', LineThickness)
grid on
title('Motor Thrust')
...
legend('Motor 1','Motor 2','Motor 3','Motor 4','Location','SouthEast')
hold on
saveas(gcf, 'MotorSpeedThrust.png')

coeff_thrustspeed = polyfit(transpose(Motor_Speeds),transpose(Motor_Thrusts),2);
yFitted5=polyval(coeff_thrustspeed, Motor1_Speed);
plot(Motor1_Speed,yFitted5,'k','LineWidth', LineThickness);
saveas(gcf, 'MotorSpeedThrust.png')
%% Motor Speed in Radian - 26/2/15
...
Motor2_Speed = [2830 3800 4570 5230 5830 6320 6760 7130 7510 8000 8480 8950 9350 9750 10020 10300 10500 ]./2./60.*2.*pi; 
Motor4_Speed = [2810 3720 4500 5200 5670 6200 6590 6900 7200 7560 7930 8330 8700 9040 9360 9730 9860]./2./60.*2.*pi;
figure
...
save('Model_Parameters','Mass','B','I_Phi','I_Theta','I_Psi','Kf','L','B_Pitch','F_yIntercept','Speed_yIntercept', 'Motor_TimeConstant','J','Kw','Drag', 'g','coeff_speed1','coeff_speed2','coeff_speed3','coeff_speed4','coeff_thrust1','coeff_thrust2','coeff_thrust3','coeff_thrust4')